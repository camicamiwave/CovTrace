...
def home(request):
    ...
    return render(request,"dashboard/index.html", {'all': all_patients})
...
def Map(request):
    ...
    map1 = folium.Map( location=[14.116667, 122.949997], tiles="CartoDB Dark_Matter",  zoom_start=14)
...
def News(request):
    return render(request,"dashboard/news_about_covid.html", {})
